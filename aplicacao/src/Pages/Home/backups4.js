...
export default function Home() {
    ...
    async function loadGraphicData(searchKey) {//Teste
        ...
        await axios.post('http://192.168.25.163:5000/temperatures_v3', params)
            .then(response => {
                //alert(JSON.stringify(response.data));
                //const {frequenciaDoDispositivo} = response.data;
                //alert("Freq: " + frequenciaDoDispositivo);
    ...
    async function changeLayout(searchKey) {
            ...
            if (device.key === searchKey) { //Se a a chave recebida for igual a lida atualmente, inverte o estado do dispositivo atual
                ...
                if (device.expanded === false) {
                    ...
                    if (dados != null && dados != undefined) {
                        ...
                        var graphicComponent = (<View><Text>{typeof dados}</Text></View>);
                    }
